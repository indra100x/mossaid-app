...
void main() async {
  ...
  // iOS quirk: foreground notifications are silent by default — need explicit presentation options
  if (defaultTargetPlatform == TargetPlatform.iOS) {
    await FirebaseMessaging.instance.setForegroundNotificationPresentationOptions(alert: true, badge: true, sound: true);
  }
  // Foreground + background tap handlers registered early; permission is requested on login (Android 13+ & iOS)
  // Note: on iOS, requestPermission() in FcmService will trigger Apple's native prompt; Android post-13 shows system dialog
